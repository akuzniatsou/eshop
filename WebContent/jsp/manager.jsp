...
<head>
	...
	<%-- PAGE TITLE --%>
<title><fmt:message key="manager" bundle="${lang}"/></title>
</head>
<body>
...
<div id="left">
		...
		<ul id="subnav">
			<li><a href="controller?command=list"><fmt:message key="list" bundle="${lang}"/></a></li>
			<li><a href="controller?page=manager"><fmt:message key="addProduct" bundle="${lang}"/></a></li>
			<li><a href="controller?page=manager"><fmt:message key="black" bundle="${lang}"/></a></li>
			<li><a href="controller?page=manager"><fmt:message key="orders" bundle="${lang}"/></a></li>
		</ul>
		</div>
</div>
