...
<div id="navi">
		...
		<div id="local">	
			<div id="local1">	
				...
				<a href="controller?page=admin&amp;locale=en">En</a>&nbsp;
				<a href="controller?page=admin&amp;locale=ru">Ru</a>
			</div>
		</div>
...
<div id="left">
		...
		<ul id="subnav">
			<li><a href="controller?command=listUser"><fmt:message key="listUser" bundle="${lang}"/></a></li>
			<li><a href="controller?page=admin"><fmt:message key="addUser" bundle="${lang}"/></a></li>
			<li><a href="controller?page=admin"><fmt:message key="updateUser" bundle="${lang}"/></a></li>
		</ul>
		</div>
</div>
